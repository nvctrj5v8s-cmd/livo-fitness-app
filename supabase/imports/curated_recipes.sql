...
values
  ...
  ('livo-chicken-rice-bowl', 'Hähnchen-Reis-Bowl', 'Sättigende Bowl mit Hähnchen, Reis und Tomate.', 25, 'Einfach', 2,
   array['Mittagessen', 'High Protein'],
   array['Hähnchen vollständig garen.', 'Reis erwärmen und Tomate schneiden.', 'Alles in einer Bowl anrichten.'],
   'livo_original', 'LIVO original', 'LIVO recipe team', 'free'),
  ...
  ('livo-skyr-berry-bowl', 'Skyr-Beeren-Bowl', 'Schneller proteinreicher Snack.', 5, 'Einfach', 1,
   ...
   'livo_original', 'LIVO original', 'LIVO recipe team', 'free'),
  ('livo-chicken-avocado-plate', 'Hähnchen-Avocado-Teller', 'Proteinreicher Teller mit Avocado und Tomate.', 20, 'Einfach', 1,
   array['Mittagessen', 'High Protein'],
   array['Hähnchen vollständig garen.', 'Avocado und Tomate schneiden.', 'Zutaten auf einem Teller anrichten.'],
   'livo_original', 'LIVO original', 'LIVO recipe team', 'premium'),
...
from (values
  ...
  ('livo-chicken-rice-bowl', 'chicken-breast', 160::numeric, 1),
  ('livo-chicken-rice-bowl', 'rice', 180::numeric, 2),
  ('livo-chicken-rice-bowl', 'tomato', 120::numeric, 3),
  ...
  ('livo-chicken-avocado-plate', 'chicken-breast', 180::numeric, 1),
  ('livo-chicken-avocado-plate', 'avocado', 80::numeric, 2),
  ('livo-chicken-avocado-plate', 'tomato', 120::numeric, 3),
